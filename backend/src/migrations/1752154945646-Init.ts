...
export class Init1752154945646 implements MigrationInterface {
    name = 'Init1752154945646'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "ingredient" ("id" SERIAL NOT NULL, "nom" character varying NOT NULL, "categorie" character varying NOT NULL, CONSTRAINT "PK_6f1e945604a0b59f56a57570e98" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "recette_ingredient" ("id" SERIAL NOT NULL, "quantite" double precision NOT NULL, "unite" character varying NOT NULL, "recetteId" integer, "ingredientId" integer, CONSTRAINT "PK_2e2af31e19e8861aeb622ce9457" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "commentaire" ("id" SERIAL NOT NULL, "texte" text NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT now(), "recetteId" integer, "utilisateurId" integer, CONSTRAINT "PK_a4fa195414f3428179d40988716" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "notation" ("id" SERIAL NOT NULL, "note" integer NOT NULL, "recetteId" integer, "utilisateurId" integer, CONSTRAINT "UQ_b7dbdc2f23fe2293276e91d1a70" UNIQUE ("recetteId", "utilisateurId"), CONSTRAINT "PK_143c801436800e80854f195b5f2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "recette" ("id" SERIAL NOT NULL, "titre" character varying NOT NULL, "description" text NOT NULL, "etapes" text NOT NULL, "temps" integer NOT NULL, "image" character varying, "utilisateurId" integer, CONSTRAINT "PK_2e3debb3047f8e82ab71e4eb2f5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "utilisateur" ("id" SERIAL NOT NULL, "nom" character varying NOT NULL, "email" character varying NOT NULL, "motDePasse" character varying NOT NULL, CONSTRAINT "UQ_e1136325a6b28e2a02b81b2f5e1" UNIQUE ("email"), CONSTRAINT "PK_838f0f99fe900e49ef050030443" PRIMARY KEY ("id"))`);
